...
export interface TextResolver$Type {
  ...
  readonly contractName: "TextResolver";
  readonly sourceName: "contracts/resolvers/profiles/TextResolver.sol";
  ...
  readonly inputSourceName: "project/contracts/resolvers/profiles/TextResolver.sol";
