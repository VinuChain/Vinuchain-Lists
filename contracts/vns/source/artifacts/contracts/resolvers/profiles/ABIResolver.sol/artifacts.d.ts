...
export interface ABIResolver$Type {
  ...
  readonly contractName: "ABIResolver";
  readonly sourceName: "contracts/resolvers/profiles/ABIResolver.sol";
  ...
  readonly inputSourceName: "project/contracts/resolvers/profiles/ABIResolver.sol";
