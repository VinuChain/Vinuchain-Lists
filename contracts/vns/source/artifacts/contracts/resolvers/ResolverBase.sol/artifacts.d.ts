...
export interface ResolverBase$Type {
  ...
  readonly contractName: "ResolverBase";
  readonly sourceName: "contracts/resolvers/ResolverBase.sol";
  ...
  readonly inputSourceName: "project/contracts/resolvers/ResolverBase.sol";
