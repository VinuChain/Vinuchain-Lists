...
export interface ResolverCaller$Type {
  readonly _format: "hh3-artifact-1";
  readonly contractName: "ResolverCaller";
  readonly sourceName: "contracts/universalResolver/ResolverCaller.sol";
  ...
  readonly inputSourceName: "project/contracts/universalResolver/ResolverCaller.sol";
...
declare module "hardhat/types/artifacts" {
  interface ArtifactMap {
    ["ResolverCaller"]: ResolverCaller$Type;
    ["contracts/universalResolver/ResolverCaller.sol:ResolverCaller"]: ResolverCaller$Type;
  }
}